                        ...
                        onPressed: () async {
                          ...
                          try {
                            await ModifyInfoTemoin.delete(
                                temoin['id'] as String);
                            context.go('/notification_update_delete',
                                extra: {
                                  'success': true,
                                  'message': null
                                });
                ...
                Row(
                  children: [
                    Container(
                      ...
                      child: temoin['img_temoin'] != null
                          ? ClipOval(
                              child: Image.asset(
                                  temoin['img_temoin'] as String,
                                  fit: BoxFit.cover))
                          : Center(
                              child: Text(
                                '${p[0].toUpperCase()}${n[0].toUpperCase()}',
                    ...
                    actions: [
                      ...
                      TextButton(
                        onPressed: () async {
                          Navigator.of(dialogCtx).pop();
                          try {
                            await DeleteCollectQuestionnaire.delete(
                                collectId);
                            context.go('/notification_update_delete',
                                extra: {
                                  'success': true,
